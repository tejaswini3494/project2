   ...
   {Data.map((item)=>{
    return (
      ...
      <div className="px-[20px] pt-[20px] ">
        <div className="rounded-3xl py-[3px] px-[12px] bg-[#a10c0c23] flex items-center gap-[4px] w-[119px]">
          <div className="w-[4px] h-[4px] text-[#A10C0C] bg-[#A10C0C] rounded-full"></div>
          <h2 className="text-[#A10C0C] text-[12px] font-light">
           {item.heading}
          </h2>
        </div>
      </div>
